...
╔═════════════════════╗
║".$yellow." █".$white." █ █ █ █ █ █ █ █ █ ".$green."║  10% Vui Lòng Chờ
╚═════════════════════╝";
usleep(100000);
@system('clear');
echo $white."Đang Kiểm Tra Sever".$green."
╔═════════════════════╗
║".$yellow." █ █".$white." █ █ █ █ █ █ █ █ ".$green."║  20% Vui Lòng Chờ
╚═════════════════════╝";
usleep(100000);
@system('clear');
echo $blue."Đang Kiểm Tra Sever".$green."
╔═════════════════════╗
║".$yellow." █ █ █".$white." █ █ █ █ █ █ █ ".$green."║  30% Vui Lòng Chờ
╚═════════════════════╝";
usleep(100000);
@system('clear');
echo $yellow."Đang Kiểm Tra Sever".$green."
╔═════════════════════╗
║".$yellow." █ █ █ █".$white." █ █ █ █ █ █ ".$green."║  40% Vui Lòng Chờ
╚═════════════════════╝";
usleep(100000);
@system('clear');
echo $lightblue."Đang Kiểm Tra Sever".$lightblue."
╔═════════════════════╗
║".$yellow." █ █ █ █ █".$white." █ █ █ █ █ ".$lightblue."║  50% Vui Lòng Chờ
╚═════════════════════╝";
usleep(100000);
@system('clear');
echo $cyan."Đang Kiểm Tra Sever".$green."
╔═════════════════════╗
║".$yellow." █ █ █ █ █ █".$white." █ █ █ █ ".$green."║  60% Vui Lòng Chờ
╚═════════════════════╝";
usleep(100000);
@system('clear');
echo $BRed."Đang Kiểm Tra Sever".$green."
╔═════════════════════╗
║".$yellow." █ █ █ █ █ █ █".$white." █ █ █ ".$green."║  70% Vui Lòng Chờ
╚═════════════════════╝";
usleep(100000);
@system('clear');
echo $purple."Đang Kiểm Tra Sever".$green."
╔═════════════════════╗
║".$yellow." █ █ █ █ █ █ █ █".$white." █ █ ".$green."║  80% Vui Lòng Chờ
╚═════════════════════╝";
usleep(100000);
@system('clear');
echo $green."Đang Kiểm Tra Sever".$green."
╔═════════════════════╗
║".$yellow." █ █ █ █ █ █ █ █ █".$white." █ ".$green."║  90% Vui Lòng Chờ
╚═════════════════════╝";
usleep(100000);
@system('clear');
echo $BRed."Đang Kiểm Tra Sever".$green."
╔═════════════════════╗
║".$yellow." █ █ █ █ █ █ █ █ █ █".$green." ║  100% Vui Lòng Chờ
".$green."╚═════════════════════╝";
usleep(200000);
@system('clear');
echo $syan."Chúc Anh Em Cày Xu Vui Vẻ!!
╔═════════════════════╗
║".$yellowb." █ █ █ █ █ █ █ █ █ █$end ".$syan."║".$greenb."  Tool Đã Sẵn Sàng
".$syan."╚═════════════════════╝\n\n";
usleep(2000000);
system('clear');
...
$link = $json["link"];
if($msg == "200"){
echo "\033[1;32mLink Key Miễn Phí : \033[1;33m$link\n";
...
echo "\n";
echo "\033[1;33m[\033[1;35mWARNING\033[1;33m] \033[1;32mNhập API Key :\033[1;35m ";
$k = trim(fgets(STDIN));
if($k!==$key){
    system('clear');
